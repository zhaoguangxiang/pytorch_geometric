...
class GATConvAG(MessagePassing):  # gatconv alpha by gcn
    ...
    def __init__(self, in_channels: Union[int, Tuple[int, int]],
                 ...
                 add_self_loops: bool = True, bias: bool = True, gi_by_gcn=False, **kwargs):
        ...
        self.att_l = Parameter(torch.Tensor(1, heads, out_channels))  # out_channels 这一维度可以理解为增加参数量用的
    ...
    def forward(self, x: Union[Tensor, OptPairTensor], edge_index: Adj,
        ...
        if isinstance(x, Tensor):
            ...
            alpha_l = (x_l * self.att_l).sum(dim=-1)  # (num_nodes, heads, out_channels) (1, heads, out_channels)
        ...
        if self.gi_by_gcn:
            alpha_gi = self.global_importance_scorer(x_r, edge_index)  # num_nodes, num_heads
    ...
    def message(self, x_j: Tensor, alpha_j: Tensor, alpha_i: OptTensor,
        ...
        alpha = alpha_j if alpha_i is None else alpha_j + alpha_i  # 这里告诉我们最后alpha i和j会是相加起来
        ...
        return x_j * alpha.unsqueeze(-1)  # 里面已经包含alpha ii
